 ...
 * representa por un arreglo unidimensional simple, se intenta crear la ilusi�n
 * que la representaci�n del estado es bidimensional. En terminos de las piezas
...
public class EstadoPuzzleOcho implements Estado {
    ...
    /**
     * Sobrecarga el m�todo igual para comparar dos estados.
     *
